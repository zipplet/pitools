...
* Moves your existing Raspberry Pi installation from the SD card to an attached USB device automatically, and configures it to run from the USB device rather than the SD card. The SD card is still required to load the initial kernel.
